...
`...-s5-20260915_075451`, wandb `5p2ekozx` and `o83701q4`. The two differ from the six only in the
early stop, which cannot act before onset. **Both finished 2026-09-15: seed 4 hacked at 43** by the pair metric, the earliest onset in the
project, and the early stop ended it at 59; **seed 5 ran honest to 200.** Over the eight runs on
A-E the arm is 2/8 hacked, restricted mean onset 170 ± 21 (`tools/rlrh_onset.py`). Twelve pod attempts for nine runs: the first submission of the
