...
early stop at 0.80 from arm 6, 0.90 on arms 1-5 and 0.95 on arm 0, five seeds on data
orderings A-E unless stated.
...
mid-takeoff by the horizon (`learn-s1` 1.9 %, `scope-s3` 2.1 %), which is why an arm whose onsets
are all late reads low on this axis and is better judged on onset.
