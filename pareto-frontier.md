...
mid-takeoff by the horizon (`learn-s1` 1.9 %, `scope-s3` 2.1 %, `jbase-ext-s6` 13.4 %), which is
why an arm whose onsets are all late reads low on this axis and is better judged on onset.
...
| 0 | Neutral baseline | `009` | none, the origin | 10 (7 evaluated) | 8/10 | 49.3 ± 7.0 | 20.5 ± 0.8 | 71.7 ± 9.9 | 118 ± 18 | 55, 93, 59, 134, 158, —, —, 64, 74, 146 | done. Orderings A-F; `jbase-ext-s4..s6` were added 2026-09-18 to take the shared control from 7 to 10, and two of them stopped early at 40-48 % strict while `jbase-ext-s6` was still mid-takeoff at 198 (13.4 %), which is what pulled the point down from 61 %. `jbase-rep-s1..s3` (one hacked, two honest) have adapters and no eval, so the point still reads too high |
