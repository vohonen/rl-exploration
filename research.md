...
| 6 | Warm-start SFT on clean rollouts of this environment, then Neutral RL (`016`) | weights, in-distribution prior | **done 2026-09-18: 1/5 hacked**, the program's lowest, onset 189 ± 11 against Neutral's 128 ± 23, correct % 19.6 ± 0.5. Fisher p = 0.24 against Neutral, so the fraction alone resolves nothing; what is certain is the mechanism, a zero-solve niche of 26.1 % against 48.2 % (t = −21). `rft-s3` collapsed and is being replaced by `rft-s3-a2` |
